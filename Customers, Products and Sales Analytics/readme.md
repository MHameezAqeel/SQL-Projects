# Customers, Products and Sales Analytics
...
## 2) 📊 Objectives 
- Determining how numbers for sales, quantity sold and distinct customers have varied over time.
- Calculating the cumulative total sales and running total sales.
- Determining how much each product category contributed to the overall sales.
- Categorize products based on their cost into four defined ranges.
- Determining how much each product cost varied as compared to the average category cost  
- Segmenting customers based on their longevity and amount spent.  
...
- **Period:** 2011 - 2014 
- **Key Columns:**  
  - `customer_key`: Unique key associated with each customer
